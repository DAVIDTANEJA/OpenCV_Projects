# 1.using trackbar taking values of 'hsv' for the 'towel' / anything you want to use to cover it.
# In Opencv folder : use file : "P-1.Color_detection_RGB_HSV.py"  to detect hsv color.
# 2.passing those values and then substract current frame from intiial frame.
