...
# we need :  1 'query' image : which is blank form  ,  2.test images -3/4 : "filled forms"  - where we get the data
# To get ROI , we have code below 1st run that code and get all ROI points and provide here , Remeber it asks : 1.for "type" : enter "text/box" as reuired , 2. type "Name" : enter "Name/Phone/Email/City" as required , After getting all ROI double/single click on top of image and press "s" it will give lists of all ROI, copy and paste it here.
